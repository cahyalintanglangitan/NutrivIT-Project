                                  ...
                                  <form class="settings-form" method="POST" action="profile.php">
                                    ...
                                    <div class="form-row">
                                      <div class="form-group">
                                        ...
                                        <input type="text" id="fullName" name="fullName" value="<?php echo htmlspecialchars($manager['nama_manager']); ?>" />
                                      </div>
                                    </div>
                                    <div class="form-row">
                                      <div class="form-group">
                                        <label for="email"><i class="fas fa-envelope"></i> Email</label>
                                        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($manager['email_manager']); ?>" />
                                      </div>
                                      <div class="form-group">
                                  ...
                                  <form class="settings-form" method="POST" action="profile.php">
                                    ...
                                    <div class="form-row">
                                      <div class="form-group">
                                        ...
                                        <input type="date" id="joinDate" name="joinDate" value="<?php echo htmlspecialchars($manager['date_joined']); ?>" />
                                      </div>
                                      <div class="form-group">
                                        <label for="employeeId"><i class="fas fa-id-card"></i> ID Karyawan</label>
                                        <input type="text" id="employeeId" name="employeeId" value="<?php echo htmlspecialchars($manager['id_karyawan']); ?>" />
                                      </div>
                                    </div>
                                  </form>
                                </div>
                                ...
                                <div class="settings-card">
                                  ...
                                  <form class="settings-form" method="POST" action="profile.php">
                                    ...
                                    <div class="password-requirements">
                                      <h5>Persyaratan Password: Minimal 8 karakter</h5>
                                    </div>
                                    <div class="form-actions">
