  ...
  januari: {
    labels: ['Kelelahan Kronis', 'Gangguan Pencernaan', 'Tulang & Gigi Lemah', 'Obesitas', 'Imunitas Rendah'],
  ...
  februari: {
    labels: ['Gangguan Pencernaan', 'Kelelahan Kronis', 'Obesitas', 'Tulang & Gigi Lemah', 'Stress & Insomnia'],
  ...
  maret: {
    labels: ['Obesitas', 'Kelelahan Kronis', 'Imunitas Rendah', 'Gangguan Pencernaan', 'Tulang & Gigi Lemah'],
  ...
  april: {
    labels: ['Kelelahan Kronis', 'Imunitas Rendah', 'Obesitas', 'Gangguan Pencernaan', 'Tulang & Gigi Lemah'],
  ...
  mei: {
    labels: ['Imunitas Rendah', 'Kelelahan Kronis', 'Gangguan Pencernaan', 'Obesitas', 'Stress & Insomnia'],
  ...
  juni: {
    labels: ['Kelelahan Kronis', 'Imunitas Rendah', 'Stress & Insomnia', 'Obesitas', 'Gangguan Pencernaan'],
...
function updateComplaintsData() {
  ...
  // Update insights
  document.getElementById('totalComplaints').textContent = `${data.total.toLocaleString()} keluhan`;
  ...
  trendElement.className = data.overallTrend.includes('Naik') ? 'insight-value negative' : 'insight-value positive';
    ...
    data: {
      ...
      if (bestSellingCtx) {
        new Chart(bestSellingCtx, {
          type: 'bar',
          data: {
            labels: ['NuVit-Multi Core', 'NuVit-Green Detox', 'NuVit-Whey Muscle', 'NuVit-C Boost', 'NuVit-Omega Brain', 'NuVit-Honey Natural', 'NuVit-Curcuma Gold', 'NuVit-BCAA Recovery'],
            datasets: [{
